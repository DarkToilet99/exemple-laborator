...
namespace Carutz
{
    class Program
    {
        ...
        {
            int opt=0;
            Carut cart1 = new Carut(new List<UnPaidItem>());
            ...
            do
            {
                ...
                switch(opt)
                {
                    ...
                    case 1:
                        ...
                        cart1.addItem(new UnPaidItem(new Item(cod, Int16.Parse(cantit))));

                        break;
                    case 2:
                        var cod2 = ReadValue("Cod:");
                        var cantit2 = ReadValue("Cantitate:");
                        cart1.removeItem(new UnPaidItem(new Item(cod2, Int16.Parse(cantit2))));
                        break;
                    case 3:
